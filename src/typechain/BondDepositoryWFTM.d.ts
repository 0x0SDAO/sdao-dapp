...
interface BondDepositoryWFTMInterface extends ethers.utils.Interface {
  functions: {
...
export class BondDepositoryWFTM extends BaseContract {
  ...
  interface: BondDepositoryWFTMInterface;
